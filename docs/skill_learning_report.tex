...
The implemented straight-cut constraint preserves the demonstrated endpoints
$p_0$ and $p_{N-1}$ and replaces only the positional GMR mean by
\begin{equation}
x_r\!\left(\phi^{(j)}\right)
=(1-\phi^{(j)})p_0+\phi^{(j)}p_{N-1},
\qquad \phi^{(j)}=\frac{j}{N-1}.
\label{eq:straight_cut_reference}
\end{equation}
Consequently $x'_r(\phi)=p_{N-1}-p_0$ is constant and the reference image is
exactly a line segment. The phase-indexed force, precision, stiffness and
damping profiles retain their learned variation. This constraint is applied
before workspace mapping and before both state-driven and time-driven
execution; hence every ablation cell uses the same straight reference.
...
& & S & T & S & T \\
\midrule
Static & off & $2.515\pm1.070$ & $2.550\pm1.097$
             & $13.411\pm12.002$ & $12.829\pm11.493$ \\
Static & on  & $3.337\pm0.843$ & $3.808\pm1.171$
             & $37.687\pm21.854$ & $48.349\pm43.207$ \\
Moving & off & $9.855\pm9.077$ & $9.655\pm8.904$
             & $25.115\pm24.013$ & $22.574\pm22.707$ \\
Moving & on  & $11.672\pm7.333$ & $12.422\pm6.878$
             & $82.328\pm17.756$ & $92.977\pm26.861$ \\
\bottomrule
\end{tabular}
\end{table}
...
$1.795$ and $1.800$\,mm for state- and time-driven execution, respectively.
Under holdback it is $3.083$ and $3.402$\,mm. The corresponding full Cartesian
RMSE increases to $28.204$ and $28.174$\,mm. Thus this 120\,N test demonstrates
...
cut-depth RMSE is $2.450$\,mm for state-driven timing and $2.477$\,mm for
time-driven timing. Under holdback the corresponding values are $5.700$ and
$6.931$\,mm, and full Cartesian RMSE is $93.953$ and $108.965$\,mm. Workpiece
...
cut-depth comparisons is significant ($p\in[0.0625,0.625]$). The large
...
$1.795$--$2.477$\,mm in the four-case cork comparison. Full Cartesian error is
larger, and the 120\,N holdback produces $28.174$--$108.965$\,mm RMSE; no
...
Representative cut-depth RMSE is $1.795$, $3.083$, $2.450$ and $5.700$\,mm,
